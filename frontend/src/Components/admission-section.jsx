...
const AdmissionSection = () => {
  return (
    <section className="bg-red-600 py-30 px-6 relative overflow-hidden">
      ...
      <div className="absolute top-30 left-35 w-86 h-86 bg-red-200 rounded-full opacity-20 -translate-x-32 -translate-y-32"></div>
      <div className="absolute bottom-15 right-30 w-96 h-96 bg-red-300 rounded-full opacity-20 translate-x-48 translate-y-48"></div>
